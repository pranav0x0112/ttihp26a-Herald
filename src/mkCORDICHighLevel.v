...
//
// On Sun Jan 18 22:13:20 IST 2026
//
//
// Ports:
// Name                         I/O  size props
...
// get_sqrt                       O    24 reg
// RDY_get_sqrt                   O     1
// get_normalize                  O    72 reg
// RDY_get_normalize              O     1
// busy                           O     1 reg
// RDY_busy                       O     1 const
// CLK                            I     1 clock
// RST_N                          I     1 reset
...
module mkCORDICHighLevel(CLK,
  ...
  // action method normalize
  input  [23 : 0] normalize_x;
  input  [23 : 0] normalize_y;
  input  EN_normalize;
  output RDY_normalize;
  ...
  // actionvalue method get_normalize
  input  EN_get_normalize;
  output [71 : 0] get_normalize;
  output RDY_get_normalize;
  ...
  // register operation_started
  reg operation_started;
  wire operation_started$D_IN, operation_started$EN;
  ...
  // register stored_x
  reg [23 : 0] stored_x;
  wire [23 : 0] stored_x$D_IN;
  wire stored_x$EN;

  // register stored_y
  reg [23 : 0] stored_y;
  wire [23 : 0] stored_y$D_IN;
  wire stored_y$EN;
  ...
  // actionvalue method get_normalize
  assign get_normalize = { stored_x, stored_y, cordic_state[79:56] } ;
  assign RDY_get_normalize =
  ...
  assign WILL_FIRE_RL_check_completion =
	     operation_started && !cordic_busy_reg && !result_ready ;
  ...
  assign MUX_cordic_state$write_1__VAL_1 =
	     { normalize_x, normalize_y, 32'd2 } ;
  assign MUX_cordic_state$write_1__VAL_2 =
	     { sqrt_magnitude_x, sqrt_magnitude_y, 32'd2 } ;
  assign MUX_cordic_state$write_1__VAL_3 = { atan2_x, atan2_y, 32'd2 } ;
  ...
  assign cordic_busy_reg$D_IN =
	     EN_normalize || EN_sqrt_magnitude || EN_atan2 || EN_sin_cos ;
  ...
  case (1'b1)
    EN_normalize: cordic_state$D_IN = MUX_cordic_state$write_1__VAL_1;
  ...
  // register current_op
  always@(EN_normalize or EN_sqrt_magnitude or EN_atan2 or EN_sin_cos)
  case (1'b1)
    EN_normalize: current_op$D_IN = 3'd6;
  ...
  assign current_op$EN =
	     EN_sin_cos || EN_atan2 || EN_sqrt_magnitude || EN_normalize ;

  // register operation_pending
  assign operation_pending$D_IN =
	     EN_normalize || EN_sqrt_magnitude || EN_atan2 || EN_sin_cos ;
  assign operation_pending$EN =
	     WILL_FIRE_RL_check_completion || EN_normalize ||
	     EN_sqrt_magnitude ||
	     EN_atan2 ||
	     EN_sin_cos ;

  // register operation_started
  assign operation_started$D_IN =
	     !EN_normalize && !EN_sqrt_magnitude && !EN_atan2 &&
	     !EN_sin_cos &&
	     !WILL_FIRE_RL_check_completion ;
  assign operation_started$EN =
	     WILL_FIRE_RL_check_completion || EN_normalize ||
	     EN_sqrt_magnitude ||
	     EN_atan2 ||
	     EN_sin_cos ||
	     operation_pending && !operation_started && cordic_busy_reg ;
  ...
  always@(EN_normalize or
	  ...
	  EN_get_normalize or EN_get_sqrt or EN_get_atan2 or EN_get_sin_cos)
  case (1'b1)
    EN_normalize || EN_sqrt_magnitude || EN_atan2 || EN_sin_cos:
	result_ready$D_IN = 1'd0;
    WILL_FIRE_RL_check_completion: result_ready$D_IN = 1'd1;
    EN_get_normalize || EN_get_sqrt || EN_get_atan2 || EN_get_sin_cos:
	result_ready$D_IN = 1'd0;
    default: result_ready$D_IN = 1'b0 /* unspecified value */ ;
  endcase
  assign result_ready$EN =
	     EN_get_normalize || EN_get_sqrt || EN_get_atan2 ||
	     EN_get_sin_cos ||
	     EN_normalize ||
	     EN_sqrt_magnitude ||
	     EN_atan2 ||
  ...
  // register stored_x
  assign stored_x$D_IN = normalize_x ;
  assign stored_x$EN = EN_normalize ;

  // register stored_y
  assign stored_y$D_IN = normalize_y ;
  assign stored_y$EN = EN_normalize ;
  ...
  begin
	...
	operation_started <= `BSV_ASSIGNMENT_DELAY 1'd0;
	result_ready <= `BSV_ASSIGNMENT_DELAY 1'd0;
	stored_x <= `BSV_ASSIGNMENT_DELAY 24'd0;
	stored_y <= `BSV_ASSIGNMENT_DELAY 24'd0;
      end
    else
      begin
	...
	if (operation_started$EN)
	  operation_started <= `BSV_ASSIGNMENT_DELAY operation_started$D_IN;
	if (result_ready$EN)
	  result_ready <= `BSV_ASSIGNMENT_DELAY result_ready$D_IN;
	if (stored_x$EN) stored_x <= `BSV_ASSIGNMENT_DELAY stored_x$D_IN;
	if (stored_y$EN) stored_y <= `BSV_ASSIGNMENT_DELAY stored_y$D_IN;
      end
  end
